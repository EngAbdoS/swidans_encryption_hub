...
ThemeData getAppTheme() {
  return ThemeData(hoverColor: ColorManager.lightPrimary,focusColor: ColorManager.lightPrimary,
    ...
    textTheme: TextTheme(
      ...
      titleSmall:
          getRegularStyle(color: ColorManager.primary, fontSize: FontSize.s20),
      labelSmall:
